...
MIDDLEWARE = [
    ...
    "drone_flight_planner.custom_middleware.TokenInvalidatedMiddleware",
]

ROOT_URLCONF = "drone_flight_planner.urls"
...
WSGI_APPLICATION = "drone_flight_planner.wsgi.application"
